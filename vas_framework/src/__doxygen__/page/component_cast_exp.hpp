 ...
 * 
 * //Cast to wrapped component. note the casted component is a weak reference of component (does not destroy
 * after out of scope). sdl::Window win = static_cast<sdl::Window>();
 * ~~~
 */