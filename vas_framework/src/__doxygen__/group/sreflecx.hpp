 ...
 * @brief A library that make C++ support some of the feature of reflection.
 * 	  
 * Reflection is the core part of mordern programming language. However, currently C++ does not supprot it.
 * This library is created just for one purpose, let C++ support at least one reflection feature -- Create
 * Object Instance from name.
 * 	  
