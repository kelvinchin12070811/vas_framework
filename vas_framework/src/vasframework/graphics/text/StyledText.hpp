...
namespace vas
{
	...
	public:
		 ...
		 * @param[in] movement Steps that text moved.
		 */
		void move(const Vector2& movement);
		/**
		 * Set the position of the text
		 * @param[in] position New position of the text.
		 */
		void setPosition(const Vector2& position);

		/**
		 * Reflect same modifier on to both foreground and background
		 * @param[in] action Function pointer of a text modifier.
		 * @param[in] value Value that passed into the modifier.
		 */
		 ...
		 * @param[in] action Function pointer of a text modifier.
		 * @param[in] value Value that passed into the modifier.
		 * @param[in] update Determine weather rerender the txt or not.
		 */
		template <typename Value>
