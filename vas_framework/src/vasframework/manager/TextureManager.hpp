...
namespace vas
{
	...
	public:
		 ...
		 * @param[in] id Pre-assigned id that represent a texture.
		 ...
		 * @param[in] id Unique id of the texture.
		 * @param[in] instance Instance of the texture.
		 ...
		 * Insert an instance of texture into the texture cache.
		 * @param[in] id Unique id of the texture.
		 * @param[in] instance Instance of the texture, instance is moved.
		 * @return true if success, false otherwise.
		 */
		bool insert(const std::string& id, sdl::Texture&& instance);
		/**
		 * Check if the instance is cached.
		 * @param[in] id Unique id of the instance.
